...
export interface SimpleExchangeAdapterInterface extends Interface {
  getFunction(
...
export interface SimpleExchangeAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleExchangeAdapter;
  waitForDeployment(): Promise<this>;

  interface: SimpleExchangeAdapterInterface;
